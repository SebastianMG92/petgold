...
<section id="<?php echo esc_attr($id); ?>" class="categoryCards custom-paddings <?php echo esc_attr($className); ?>" style="--pt-desktop:<?php echo $pt_desktop; ?>px;--pb-desktop:<?php echo $pb_desktop; ?>px; --pt-mobile:<?php echo $pt_desktop; ?>px; --pb-mobile:<?php echo $pb_mobile; ?>px; background-image: url(<?php echo $image["url"]; ?>);">
                ...
                ?>
                    ...
                    */
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="categoryCards__card" style="background-color: <?php echo $color; ?>;">
                            <figure class="categoryCards__card--image">
                                <img src="<?php echo $image_card["sizes"]["medium"]; ?>" alt="<?php echo $image_card["alt"]; ?>" srcset="">
                            ...
                            <div class="categoryCards__card--content">
                                <div>
                                    <figure class="icon">
                                        <img src="<?php echo $icon["sizes"]["thumbnail"]; ?>" alt="<?php echo $icon["alt"]; ?>" srcset="">
                                    </figure>
                                    <h3 class="heading">
                                        <?php echo $heading; ?>
                                    </h3>
                                ...
                                <a href="<?php echo $link_url; ?>" class="btn-arrow btn-white" target="<?php echo $link_target; ?>">
                                    <?php echo $link_title; ?>
